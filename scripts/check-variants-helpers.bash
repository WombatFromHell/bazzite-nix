...
#
#   check-variants-registry.bash — skopeo retry/inspect, tag listing, prev-ref lookup, build-needed decision
#   check-variants-tags.bash      — metadata extraction, canonical tag, tag generation, variant resolution
#
